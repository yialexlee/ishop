...
`		<h2 class="title text-center mb-2">Member Details</h2><!-- End .title text-center mb-2 -->
		...
		<form action="#" method="POST">
										...
										<div class="form-group">
                                            <label ><strong>Member Email </strong></label>
                                            <input type="email" class="form-control" name="email" required>
                                        </div>
										<div class="form-group">
                                            <label ><strong>Member Password (long 8-25 and required 1 alphabet,1 capital letter,1 number and 1 symbol)</strong></label>
                                            <input type="password" class="form-control" name="pass"  pattern="(?=.*[$@$!%*?&.;'-_/#^)(?=.*?[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,25}" required title="long 8-25 and required 1 alphabet,1 capital letter,1 number and 1 symbol " >
                                        </div>
...
$passmd5=md5($pass);
$status="Active";
$sql= "Insert INTO member(name,email,password,status)VALUES('$name','$email','$passmd5','$status')";
if(mysqli_query($connect,$sql)){echo "<script> window.location.assign('memberlist.php'); </script>";}}?>
           </main>
