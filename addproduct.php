		...
		<form action="#" method="POST">
                                    <div class="form-group">
										...
										<div class="form-group">
											...
											<option value="Pendrive">Flash Drive</option>
											<option value="Speaker">Speaker</option>
											<option value="Microphone">Microphone</option>
											<option value="Webcam">Webcam</option>
											<option value="Display Adapter">Display Adapter</option>
											</select>
                                        </div>
										<div class="form-group">
											...
											<option value="Pendrive">Kingstom</option>
											<option value="Beats">Beats</option>
											<option value="Tonor">Tonor</option>
											<option value="Microsoft">Webcam</option>
											</select>
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="connectivity" required>
                                        </div>
										<div class="form-group">
                                            <label ><strong>Product Price (RM)</strong></label>
...
$price=$_POST["price"];
$stock=$_POST["stock"];
$sqlcheck= "select * from product WHERE Product_Code = '$code'";
$resultcheck = mysqli_query($connect,$sqlcheck);
$sql= "Insert INTO product(Product_NAME,Product_DESCRIPTION,Product_PIC,Product_PRICE,Product_STOCK,Product_Status,Product_Code,Product_Connectivity,Product_CATEGORY,Product_BRAND)VALUES('$name','$description','$pic','$price','$stock','$status','$code','$connectivity','$category','$brand')";
$sqlc= "Insert INTO category(Category_NAME,Product_code)VALUES('$category','$code')";
$sqlb= "Insert INTO brand(Brand_NAME,Product_code)VALUES('$brand','$code')";
...
else{?><script>window.alert("This Product Code Already Existed !!!.");window.location.assign('productlist.php');</script><?php }}?>			
           </main>
