...
<head>
    ...
    <title>Ishop-Contact List</title>
...
<div id="Active" class="tabcontent">
	                			<table class="table table-cart table-mobile" style="width:1150px">
									...
									<tbody>
										...
										$sql = "Select * from member where status='Active' ORDER BY id DESC LIMIT $start,$end";
										...
										<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo md5($row["password"]); ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo $row["phone"]; ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo $row["address"]; ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo $row["state"]; ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo $row["city"]; ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><?php echo $row["postcode"]; ?></td>
											<td class="price-col" style="padding-left:10px;padding-right:10px"><button class="btn-remove" ><a href="editmember.php?mid=<?php echo $row["id"]?>">EDIT</a></button></td>
											<td class="remove-col"><button class="btn-remove" ><a href="memberlist.php?del&id=<?php echo $row["id"]?>" onclick="return confirmation();"><i class="icon-close"></i></a></button></td>
										</tr><?php } ?>
								...
								<div class="cart-bottom" style="width:1150px">
			            			...
			            			<a href="addmember.php" class="btn btn-outline-dark-2"><span>ADD MEMBER</span></a>
		            			</div><!-- End .cart-bottom -->
	  ...
	  <nav aria-label="Page navigation" style="width:1150px">
							    <ul class="pagination justify-content-center">
							        ...
							        <li class="page-item"><a class="page-link" href="?memberlist&page=<?php echo $p ?>"><?php echo $p ?></a></li><?php }}?>
							        <li class="page-item">
							            <a class="page-link page-link-next" href="?memberlist&page=<?php echo $next ?>" aria-label="Next">
...
{
	$option=confirm("Do you confirm to block this member from member list ?");
	return $option;
}
</script>
<?php
if(isset($_GET['del']) ){
    ...
    $id=$_GET['id'];
    mysqli_query($connect,"UPDATE member SET status='Blocked' WHERE id='$id'");
     echo "<script> window.location.assign('memberlist.php'); </script>";
...
<div id="Blocked" class="tabcontent">
	                			<table class="table table-cart table-mobile" style="width:1150px">
									...
									<tbody>
										...
										$sql = "Select * from member where status='Blocked' ORDER BY id DESC LIMIT $start,$end";
										$result = mysqli_query($connect,$sql);
										while($row=mysqli_fetch_assoc($result)){?>
											<td class="product-col">
												<div class="product">
