    ...
    <div class="page-wrapper">
		...
		<main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Category<span>iShop</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="row filter_data" >
                				...
                				<nav aria-label="Page navigation" style="width:1150px;padding-right:350px;">
							    <ul class="pagination justify-content-center">
							        <li class="page-item">
							            <a class="page-link page-link-prev" href="?page=<?php echo $previous; ?>" aria-label="Previous" tabindex="-1" aria-disabled="true">
									...
									for ($p=1;$p<5;$p++){
									if ($page == $p) {?>
							        <li class="page-item active" aria-current="page" class="common_selector page" value="$p"><a class="page-link" href="#"><strong><?php echo $p ?></strong></a></li><?php }
									else{?>
							        <li class="page-item"><a class="page-link" href="?page=<?php echo $p ?>"><?php echo $p ?></a></li><?php }}?>
							        <li class="page-item">
							            <a class="page-link page-link-next" href="?page=<?php echo $next ?>" aria-label="Next">
                			...
                			<div class="sidebar sidebar-shop">
                				...
                				<div class="widget widget-collapsible">
									...
									?>	
													<div >
														...
														<input type="checkbox" class="common_selector category"  id="<?php echo $row['Category_NAME']; ?>" value="<?php echo $row['Category_NAME']; ?>">
														<label  for="<?php echo $row['Category_NAME']; ?>"><?php echo $row['Category_NAME']; ?></label>
													</div><!-- End .custom-checkbox --><?php } ?>
													</div><!-- End .filter-item -->
        						...
        						<div class="widget widget-collapsible">
									...
									<div class="filter-items filter-items-count">
												<div >
														<?php 
									$query = "SELECT DISTINCT(Brand_NAME) FROM brand ORDER BY Brand_NAME ASC";
									$result = mysqli_query($connect, $query);
									while($row = mysqli_fetch_array($result))
									{	
									?>	
													<div >
														...
														<input type="checkbox" class="common_selector brands" id="<?php echo $row['Brand_NAME']; ?>" value="<?php echo $row['Brand_NAME']; ?>">
														<label  for="<?php echo $row['Brand_NAME']; ?>"><?php echo $row['Brand_NAME']; ?></label>
													</div><!-- End .custom-checkbox --><?php } ?>
													</div><!-- End .filter-item -->
											</div><!-- End .filter-items -->
								...
								<div class="widget widget-collapsible">
									...
									<div class="filter-items filter-items-count">
												<div >
														<?php 
									$query = "SELECT DISTINCT(Product_Connectivity) FROM product ORDER BY Product_Connectivity ASC";
									$result = mysqli_query($connect, $query);
									while($row = mysqli_fetch_array($result))
									{	
									?>	
													<div >
														...
														<input type="checkbox" class="common_selector connectivity" id="<?php echo $row['Product_Connectivity']; ?>" value="<?php echo $row['Product_Connectivity']; ?>">
														<label  for="<?php echo $row['Product_Connectivity']; ?>"><?php echo $row['Product_Connectivity']; ?></label>
													</div><!-- End .custom-checkbox --><?php } ?>
													</div><!-- End .filter-item -->
											</div><!-- End .filter-items -->
									...
									<div class="filter-items filter-items-count">
												<div >
													...
													<div >
														...
														<input type="checkbox" class="common_selector sort" id="49" value="49">
														<label  for="49">Less than RM50</label>
													</div><!-- End .custom-checkbox -->
													<div >
											
														<input type="checkbox" class="common_selector sort" id="99" value="99">
														<label  for="99">Less than RM100</label>
													</div><!-- End .custom-checkbox -->
													<div >
											
														<input type="checkbox" class="common_selector sort" id="199" value="199">
														<label  for="199">Less than RM200</label>
													</div><!-- End .custom-checkbox -->
													<div >
											
														<input type="checkbox" class="common_selector sort" id="299" value="299">
														<label  for="299">Less than RM300</label>
													</div><!-- End .custom-checkbox -->
													</div><!-- End .filter-item -->
											</div><!-- End .filter-items -->
...
$(document).ready(function(){
    ...
    function filter_data(search)
    {
		...
		var connectivity = get_filter('connectivity');

        $.ajax({
            url:"fetch_data.php",
            method:"POST",
            data:{action:action,category:category,brands:brands,connectivity:connectivity,sort:sort},
