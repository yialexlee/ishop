...
{
	$mid = $_GET["mid"];
	$sqls = "SELECT * FROM member where id = '$mid'";
...
$passmd5=md5($pass);
$status="Active";
$sql= "UPDATE member SET name='$name',email='$email',password='$passmd5',status='$status' WHERE id='$mid'";
