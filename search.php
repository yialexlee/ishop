...
<head>
    ...
    <title>Ishop-Search Result-<?php echo $_POST["q"] ?></title>
...
<body>
    <div class="page-wrapper">
		...
		<main class="main">
										...
										if(isset($_POST["q"])){
										$q = $_POST["q"];
										$sql = "Select * from product where Product_NAME LIKE '%$q%' or Product_CATEGORY LIKE '%$q%' or Product_BRAND LIKE '%$q%' LIMIT $start,$end";
										$result = mysqli_query($connect,$sql);}?>
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Search Result : <?php echo $q ?></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
	                			...
	                			<table class="table table-cart table-mobile" style="width:1150px">
									...
									<tbody>
										...
										while($row=mysqli_fetch_assoc($result)){?>
											...
											<td class="price-col"><button class="btn-remove" ><a href="product.php?detail&id=<?php echo $row["Product_ID"]?>">DETAILS</a></button></td>
										</tr><?php } ?>
	  ...
	  <nav aria-label="Page navigation" style="width:1150px">
							    <ul class="pagination justify-content-center">
							        ...
							        <li class="page-item"><a class="page-link" href="#"><?php echo $p ?></a></li><?php }}?>
							        <li class="page-item">
